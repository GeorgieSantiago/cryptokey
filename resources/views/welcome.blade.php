...
<html lang="en-US">
  ...
  <body style="background: url({{'images/cover.jpg'}});" id="top"><div class="site-wrapper">
  <div class="site-wrapper-inner">
    <div class="cover-container">
      <div class="masthead clearfix">
        <div class="inner">
          <h3 class="masthead-brand">Milestone Artisans Presents: </h3>
        ...
        <h1 class="cover-heading">Cryptokey</h1>
        <p class="lead cover-copy">The one stop adminastrative tool for CryptoCurrency</p>
        ...
        <a href="{{ route('home') }}" class="lead"><button type="button" class="btn btn-lg btn-default btn-notify">Launch the app</button></a>
      </div>
      <div class="mastfoot">
        <div class="inner">
          <p>&copy; Your Company. Design: <a href="#" target="_blank">MilestoneArtisan</a>.</p>
        </div>
      </div>
